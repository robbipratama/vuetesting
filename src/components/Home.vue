  ...
  <div class="home">
    ...
    <div class="row my-5">
        ...
        <div class="form-inline" style="width: 100%;">
            <div class="form-group mx-sm-2 mb-2" style="width: 100%;">
                <input type="text" class="form-control" placeholder="Search Meal" v-model="query">
                <button type="submit" class="btn" @click="getResult(query)">Search</button>
            </div>
        </div>
        </center>
    </div>
    <div class="row">
        <div class="col-md-3" v-for="result in results" :key="result.idMeal" style="text-align: center;">
           <b-button variant="primary"  style="text-align: left" @click="addFav(result.idMeal,result.strMealThumb,result.strMeal,result.strCategory)"><b-icon icon="bookmark-plus" /> Add Favorite</b-button>
